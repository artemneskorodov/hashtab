...
Разброс величины достаточно велик, однако мы используем эту функцию только для доступа к хэш таблице, соотвественно её скорость нам будет очень важна, а такой алгоритм хэша позволяет сильно оптимизировать программу.
